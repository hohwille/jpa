...
public class JpqlSelectStatementImpl<E, T> extends AbstractSelectStatement<E, JpqlSelectStatement<E>, T> implements JpqlSelectStatement<E> {
   ...
   * @param dialect - see {@link #getDialect()}. Typically {@link JpqlDialect#INSTANCE}.
  ...
  @Override
  public JpqlSelectStatement<E> andFrom(EntityAlias<?>... aliases) {

    feature(FeatureAndFromImpl.class).andFrom(aliases);
    return self();
  }
